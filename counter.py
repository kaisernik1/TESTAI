...
def parse_log_file(input_file, output_file):
    ...
    try:
        ...
        with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
            ...
            writer.writerow(['UID', 'Timestamp', 'Status', 'Videos Count', 'Query'])
                        ...
                        if match:
                            ...
                            if i + 1 < len(lines):
                                ...
                                if "Not Blacklisting" in next_line:
                                    ...
                                    # Ищем строку с информацией о скрапинге
                            ...
                            print(f"Извлечено: UID={uid}, Timestamp={timestamp}, Status={status}, Videos={videos_count}, Query={query}")
                            writer.writerow([uid, timestamp, status, videos_count, query])
                        else:
